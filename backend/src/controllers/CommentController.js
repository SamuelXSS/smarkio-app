...
module.exports = {
  ...
  async store(req, res) {
    ...
    return res.status(201).json({
      success: "Comentário adicionado com sucesso, ouça ele!",
      create,
    });
  },
  ...
  async update(req, res) {
    ...
    return res
      .status(200)
      .json({ success: "Comentário atualizado com sucesso, ouça :D", update });
  },
  ...
  async destroy(req, res) {
    ...
    return res
      .status(200)
      .json({ success: "Comentário deletado com sucesso!" });
  },
};
